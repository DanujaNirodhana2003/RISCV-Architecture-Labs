...
# Description:  Matrix multiply optimized for column-major access.
...
loop_k: 
    ...
    slli t0, s4, 2                      #change this.                   # t0 = k * 4 (since Matrix B has 4 columns per row)
    add  t0, t0, s6                             # t0 = k * 4 + j (the linear index of B[k][j])
